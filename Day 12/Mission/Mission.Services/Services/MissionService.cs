...
namespace Mission.Services.Services
{
    public class MissionService(IMissionRepository missionRepository) : IMissionService
    {
        ...
        public async Task<bool> MissionApplicationDisapprove(int missionApplicationId)
        {
            return await _missionRepository.MissionApplicationDisapprove(missionApplicationId);
        }
    }
}
