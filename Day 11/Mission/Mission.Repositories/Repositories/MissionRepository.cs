...
namespace Mission.Repositories.Repositories
{
    public class MissionRepository(MissionDbContext dbContext) : IMissionRepository
    {
        ...
        // Mission\Repositories\Repositories\MissionRepository.cs
        public async Task<bool> UpdateMission(MissionRequestViewModel model)
        {
            ...
            mission.TotalSheets = model.TotalSeats; // Assuming TotalSeats maps to TotalSheets
        ...
        public async Task<bool> DeleteMission(int missionId)
        {
            ...
            // Soft delete using the IsDeleted property
